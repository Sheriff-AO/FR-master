...
class Site(models.Model):
    ...
    sudo_name = models.CharField(max_length=80)
    current_fuel_level = models.IntegerField()
    generator_size = models.CharField(max_length=10)
    phcn = models.CharField(max_length=50)
    fuel_level_date = models.DateTimeField()
    fuel_tank_size = models.IntegerField()
    last_delivery_date = models.DateTimeField()
    last_delivery_quantity = models.DateTimeField()
    run_hour = models.IntegerField()
    last_refill = models.IntegerField()
